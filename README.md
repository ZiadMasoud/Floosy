...
1. **Dashboard**: View your financial overview with total income, spending, and balance.
2. **Records**: Add new transactions by clicking the "Add Record" button. Categorize your income and expenses.
3. **Analytics**: Explore charts showing spending by category and monthly trends.
4. **Settings**: Manage categories, export/import data, or reset all records.
